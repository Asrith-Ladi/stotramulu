...
5. Meanings remain a separate editorial task. Exactly 65 of 1,267 displayed blocks currently have meanings: Lalitha 5/187, Vishnu 44/45, Lingashtakam 8/9 and Bilvashtakam 8/9. Dedicated comparison sources and a 2026-09-26 source-check date are now recorded, but all four sets remain review-pending and no source translation was copied. The UI hides the meaning control for the other 28 prayers and shows exact coverage where meanings exist. Suprabhatam meanings remain detached rather than being mapped onto newly numbered verses.
