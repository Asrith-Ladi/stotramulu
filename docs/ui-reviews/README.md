...
![Phone view highlighting the sticky reader progress strip](phase5-reader-progress-mobile.png)
...
![Phone view highlighting the recently-read continuation card](phase5-home-continue-mobile.png)
