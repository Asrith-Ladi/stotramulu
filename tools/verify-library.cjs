...
let prevented=false;last='';c.handlePrayerCardClick({button:0,ctrlKey:false,metaKey:false,shiftKey:false,altKey:false,preventDefault(){prevented=true}},'lalitha');assert.equal(prevented,true);assert.equal(last,'lalitha');
prevented=false;last='';c.handlePrayerCardClick({button:0,ctrlKey:true,metaKey:false,shiftKey:false,altKey:false,preventDefault(){prevented=true}},'lalitha');assert.equal(prevented,false);assert.equal(last,'');
